...
RUN wget -O --no-check-certificate PDO_IBM-1.3.4-patched "https://codeload.github.com/dreamfactorysoftware/PDO_IBM-1.3.4-patched/zip/master"
RUN wget -O oracle-oci12.rpm --no-check-certificate "https://onedrive.live.com/download?cid=00FC9869C6A3ECE0&resid=FC9869C6A3ECE0%21161158&authkey=ABeOpjPCxGbFr_U"
RUN wget -O oracle-oci12-devel.rpm --no-check-certificate "https://onedrive.live.com/download?cid=00FC9869C6A3ECE0&resid=FC9869C6A3ECE0%21161138&authkey=AM59yqBP-Unga1o"
RUN wget -O drive-ibm.tar.gz --no-check-certificate "https://onedrive.live.com/download?cid=00FC9869C6A3ECE0&resid=FC9869C6A3ECE0%21161533&authkey=AIKzN7Al10gYacA"
